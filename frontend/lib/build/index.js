    ...
    "production" !== process.env.NODE_ENV &&
      (function () {
        ...
        var prefix,
          suffix,
          reentry = !1;
        var componentFrameCache = new ("function" === typeof WeakMap
          ? WeakMap
          : Map)();
...
var post = function (basePath) {
  return function (path_1, body_1, _a) {
    return __awaiter(void 0, [path_1, body_1, _a], void 0, function (
      path,
      body,
      _b
    ) {
      var queryParams,
        ...
        newError,
        payload;
      var withSession = _b.withSession,
        params = _b.params;
...
var get = function (basePath) {
  return function (path_1, _a) {
    return __awaiter(void 0, [path_1, _a], void 0, function (path, _b) {
      var queryParams,
        url,
        credentials,
        response,
...
var useQuerier = function (basePath) {
  var querier = reactExports.useMemo(
    function () {
      return getQuerier(basePath);
    },
    [basePath]
  );
  return querier;
...
var ThemeBase = function (_a) {
  ...
  return jsxRuntimeExports.jsxs(reactExports.Fragment, {
    children: [
      children,
      jsxRuntimeExports.jsx("style", { children: userStyles.join("\n") }),
    ],
  });
};

// todo: feedback: it would be useful to be able to use the supertokens components (buttons, inputs, boxes, cards, forms, etc).
var BanUserPage = function (props) {
  var _a = reactExports.useState(),
    error = _a[0],
    setError = _a[1];
  var _b = reactExports.useState("public"),
    tenantId = _b[0],
    setTenantId = _b[1];
  var _c = reactExports.useState(),
    email = _c[0],
    setEmail = _c[1];
  var _d = reactExports.useState(null),
    banStatus = _d[0],
    setBanStatus = _d[1];
  ...
  var onError = reactExports.useCallback(
    function (error) {
  ...
  var getBanStatus = reactExports.useCallback(
    function (email) {
      return querier
  ...
  var updateBanStatus = reactExports.useCallback(
    function (isBanned) {
      return querier
        .post(
  ...
  var onCheckStatus = reactExports.useCallback(
    function (e) {
      e.preventDefault();
      if (!email) {
  ...
  var onBanUser = reactExports.useCallback(
    function (e) {
      e.preventDefault();
  ...
  var onUnbanUser = reactExports.useCallback(
    function (e) {
      e.preventDefault();
      if (!email) {
        setError("Email is required");
  ...
  return jsxRuntimeExports.jsx(ThemeBase, {
    userStyles: [styles],
    children: jsxRuntimeExports.jsx("div", {
      className: "supertokens-plugin-user-banning",
      children: jsxRuntimeExports.jsx("div", {
        className: "container",
        children: jsxRuntimeExports.jsxs("div", {
          ...
          children: [
            ...
            jsxRuntimeExports.jsx("p", {
              children:
                "This page is used to ban and unban users. It is useful for preventing users from accessing your application.",
            }),
            jsxRuntimeExports.jsx("div", { className: "divider" }),
            !!error &&
              jsxRuntimeExports.jsx("div", {
                    ...
                    jsxRuntimeExports.jsx("div", {
                      ...
                      children: jsxRuntimeExports.jsx("div", {
                        ...
                        children: jsxRuntimeExports.jsx("input", {
                          ...
                          onChange: function (e) {
                            return setTenantId(e.target.value);
                          },
                        }),
                      }),
                    }),
...
var init = function (_a) {
  var apiDomain = _a.apiDomain,
    websiteDomain = _a.websiteDomain;
  return {
    id: PLUGIN_ID,
    routeHandlers: [
      {
